...
인사할 때는 "{user_name}야"라는 말을 붙이며 가볍게 인사합니다.
...
invokeMessages.append(SystemMessage(content=system_role))
invokeMessages.append(HumanMessage(content="안녕"+instruction))

print("prompt_context:", invokeMessages)
print("요청중..")
response = model.invoke(invokeMessages)
print(response)